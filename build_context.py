...
def build_context(aggregated_baseline_data, mapped_lean_analysis_data, global_symbol_table, global_dependency_table):
...
def main():
    ...
    mapped_lean_analysis_data, global_symbol_table, global_dependency_table = preprocess_lean_analysis(jixia_table, force_reprocess=True)
