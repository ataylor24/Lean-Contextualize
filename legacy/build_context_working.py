...
def preprocess_lean_analysis(jixia_table, force_reprocess=False):
    ...
    return jixia_name_map, global_symbol_table
...
def build_context(aggregated_baseline_data, mapped_lean_analysis_data, global_symbol_table):
...
def main():
    ...
    mapped_lean_analysis_data, global_symbol_table = preprocess_lean_analysis(jixia_table, force_reprocess=True)
    aggregated_baseline_data = preprocess_baseline_data(force_reprocess=False)
    # Pass the new global_symbol_table
    test_examples_with_context = build_context(aggregated_baseline_data, mapped_lean_analysis_data, global_symbol_table)
